...
public static class ErpModuleCatalog
{
    ...
    [
        ...
        M("Finance", "Finance Overview", "/erp/finance", "Review accounting performance and control the ledgers.", "Receivables", "Payables", "Management accounts"),
        M("Finance", "Banking", "/erp/bank", "Manage bank accounts, imported transactions and reconciliation.", "Statements", "Matching", "Reconciliation"),
        M("Finance", "Expenses", "/erp/expenses", "Capture and approve operational expenditure.", "Receipts", "Approval", "Cost centres"),
        M("Finance", "VAT", "/erp/vat", "Review VAT inputs, outputs and return periods.", "VAT codes", "Returns", "Reverse charge"),
        M("Finance", "Journals", "/erp/journals", "Post balanced entries into open accounting periods.", "Journal entries", "Trial balance", "Period control"),
        M("Finance", "Budgets", "/erp/budgets", "Compare departmental budgets and forecasts.", "Departments", "Variance", "Forecasts"),
        M("Finance", "Suppliers", "/erp/suppliers", "Manage suppliers and purchase ledger balances.", "Suppliers", "Bills", "Payment history"),
        M("Finance", "Corporate Finance", "/erp/corporate-finance", "Review corporate exposure, billing and statements.", "Credit limits", "Statements", "Monthly billing"),
        M("Finance", "Driver Payments", "/erp/driver-payments", "Prepare commission-based driver settlements.", "Commission", "Adjustments", "Payroll export"),

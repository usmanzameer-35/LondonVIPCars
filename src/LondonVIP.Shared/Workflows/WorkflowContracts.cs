...
{
 public const string BookingCreated=nameof(BookingCreated),BookingAssigned=nameof(BookingAssigned),BookingAccepted=nameof(BookingAccepted),BookingDeclined=nameof(BookingDeclined),DriverArrived=nameof(DriverArrived),PassengerOnboard=nameof(PassengerOnboard),JourneyCompleted=nameof(JourneyCompleted),BookingCancelled=nameof(BookingCancelled),QuotationCreated=nameof(QuotationCreated),QuotationAccepted=nameof(QuotationAccepted),QuotationExpired=nameof(QuotationExpired),InvoiceCreated=nameof(InvoiceCreated),InvoiceDueSoon=nameof(InvoiceDueSoon),InvoiceOverdue=nameof(InvoiceOverdue),PaymentReceived=nameof(PaymentReceived),CustomerCreated=nameof(CustomerCreated),DriverCreated=nameof(DriverCreated),VehicleAdded=nameof(VehicleAdded),VehicleLicenceExpiring=nameof(VehicleLicenceExpiring),InsuranceExpiring=nameof(InsuranceExpiring),MOTExpiring=nameof(MOTExpiring),DriverLicenceExpiring=nameof(DriverLicenceExpiring),CorporateAccountCreated=nameof(CorporateAccountCreated),CorporateAccountOnHold=nameof(CorporateAccountOnHold);
}

...
public sealed class NewsletterSubscriber
{
    ...
    public DateTimeOffset SubscribedAt { get; set; } public DateTimeOffset? ConfirmedAt { get; set; } public DateTimeOffset? UnsubscribedAt { get; set; }
}
public sealed class MarketingCampaign
{
    ...
    public int ClickCount { get; set; } public int ConversionCount { get; set; } public decimal Cost { get; set; } public decimal Revenue { get; set; } public DateTimeOffset CreatedAt { get; set; }
}
...
public sealed class SocialPost
{
    ...
    public DateTimeOffset? PublishedAt { get; set; } public string? ProviderReference { get; set; } public int EngagementCount { get; set; } public DateTimeOffset CreatedAt { get; set; }
}

...
public enum PdfDocumentType { Invoice, Receipt, BookingConfirmation, CorporateStatement, DriverSummary, BalanceSheet, ProfitAndLoss, TrialBalance, CashFlow, VatReport, CustomerStatement, SupplierStatement, DriverSettlement, Journal, CreditNote, GeneralLedger, ExpenseAnalysis, RevenueAnalysis, BudgetReport, AgedDebtors, AgedCreditors }

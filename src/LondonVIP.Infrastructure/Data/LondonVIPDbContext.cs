...
public class LondonVIPDbContext(DbContextOptions<LondonVIPDbContext> options) : IdentityDbContext<ApplicationUser, IdentityRole<Guid>, Guid>(options)
{
    ...
    public DbSet<CreditNote> CreditNotes => Set<CreditNote>(); public DbSet<CreditNoteLine> CreditNoteLines => Set<CreditNoteLine>();
    public DbSet<RecurringInvoiceSchedule> RecurringInvoiceSchedules => Set<RecurringInvoiceSchedule>(); public DbSet<AccountingJournalLink> AccountingJournalLinks => Set<AccountingJournalLink>();
    public DbSet<SupplierPayment> SupplierPayments => Set<SupplierPayment>(); public DbSet<SupplierPaymentAllocation> SupplierPaymentAllocations => Set<SupplierPaymentAllocation>();
    public DbSet<BankImportBatch> BankImportBatches => Set<BankImportBatch>(); public DbSet<BankRule> BankRules => Set<BankRule>(); public DbSet<BankReconciliation> BankReconciliations => Set<BankReconciliation>(); public DbSet<VatAdjustment> VatAdjustments => Set<VatAdjustment>();
    public DbSet<BankTransactionMatch> BankTransactionMatches => Set<BankTransactionMatch>(); public DbSet<VatSubmission> VatSubmissions => Set<VatSubmission>();
    public DbSet<AccountingPostingProfile> AccountingPostingProfiles => Set<AccountingPostingProfile>();
    public DbSet<FinanceRecordState> FinanceRecordStates => Set<FinanceRecordState>(); public DbSet<FinanceRecordHistory> FinanceRecordHistories => Set<FinanceRecordHistory>();
    public DbSet<SupplierCredit> SupplierCredits => Set<SupplierCredit>(); public DbSet<SupplierContract> SupplierContracts => Set<SupplierContract>(); public DbSet<SupplierDocument> SupplierDocuments => Set<SupplierDocument>();
    public DbSet<SocialProviderConnection> SocialProviderConnections => Set<SocialProviderConnection>(); public DbSet<OAuthAuthorizationState> OAuthAuthorizationStates => Set<OAuthAuthorizationState>();
    public DbSet<CampaignDelivery> CampaignDeliveries => Set<CampaignDelivery>(); public DbSet<AnalyticsSession> AnalyticsSessions => Set<AnalyticsSession>(); public DbSet<AnalyticsEvent> AnalyticsEvents => Set<AnalyticsEvent>();
    public DbSet<AiMarketingGeneration> AiMarketingGenerations => Set<AiMarketingGeneration>(); public DbSet<ContentTaxonomy> ContentTaxonomies => Set<ContentTaxonomy>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SupplierCredit>(e=>{e.Property(x=>x.Reference).HasMaxLength(100);e.Property(x=>x.NetAmount).HasPrecision(18,2);e.Property(x=>x.VatAmount).HasPrecision(18,2);e.Property(x=>x.TotalAmount).HasPrecision(18,2);e.Property(x=>x.AmountApplied).HasPrecision(18,2);e.Property(x=>x.Reason).HasMaxLength(1000);e.HasIndex(x=>new{x.CompanyId,x.SupplierId,x.Reference}).IsUnique();e.HasIndex(x=>new{x.CompanyId,x.Status,x.CreditDate});e.HasOne(x=>x.Supplier).WithMany().HasForeignKey(x=>x.SupplierId).OnDelete(DeleteBehavior.Restrict);e.HasOne(x=>x.SupplierInvoice).WithMany().HasForeignKey(x=>x.SupplierInvoiceId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<SupplierContract>(e=>{e.Property(x=>x.Reference).HasMaxLength(100);e.Property(x=>x.Title).HasMaxLength(250);e.Property(x=>x.Value).HasPrecision(18,2);e.Property(x=>x.Notes).HasMaxLength(4000);e.HasIndex(x=>new{x.CompanyId,x.SupplierId,x.Reference}).IsUnique();e.HasIndex(x=>new{x.CompanyId,x.Status,x.EndsOn});e.HasOne(x=>x.Supplier).WithMany().HasForeignKey(x=>x.SupplierId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<SupplierDocument>(e=>{e.Property(x=>x.Category).HasMaxLength(100);e.Property(x=>x.FileName).HasMaxLength(260);e.Property(x=>x.StoragePath).HasMaxLength(2000);e.HasIndex(x=>new{x.CompanyId,x.SupplierId,x.Category});e.HasIndex(x=>new{x.CompanyId,x.ExpiresOn});e.HasOne(x=>x.Supplier).WithMany().HasForeignKey(x=>x.SupplierId).OnDelete(DeleteBehavior.Restrict);e.HasOne(x=>x.SupplierContract).WithMany().HasForeignKey(x=>x.SupplierContractId).OnDelete(DeleteBehavior.Restrict);});
        ...
        modelBuilder.Entity<CreditNote>(e=>{e.Property(x=>x.CreditNoteNumber).HasMaxLength(50);e.Property(x=>x.Subtotal).HasPrecision(18,2);e.Property(x=>x.TaxAmount).HasPrecision(18,2);e.Property(x=>x.TotalAmount).HasPrecision(18,2);e.Property(x=>x.Reason).HasMaxLength(1000);e.HasIndex(x=>new{x.CompanyId,x.CreditNoteNumber}).IsUnique();e.HasIndex(x=>new{x.CompanyId,x.InvoiceId,x.Status});e.HasOne(x=>x.Invoice).WithMany().HasForeignKey(x=>x.InvoiceId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<CreditNoteLine>(e=>{e.Property(x=>x.Description).HasMaxLength(500);e.Property(x=>x.Quantity).HasPrecision(18,2);e.Property(x=>x.UnitPrice).HasPrecision(18,2);e.Property(x=>x.TaxRate).HasPrecision(5,2);e.Property(x=>x.NetAmount).HasPrecision(18,2);e.Property(x=>x.TaxAmount).HasPrecision(18,2);e.Property(x=>x.TotalAmount).HasPrecision(18,2);e.HasIndex(x=>new{x.CompanyId,x.CreditNoteId});e.HasOne(x=>x.CreditNote).WithMany(x=>x.Lines).HasForeignKey(x=>x.CreditNoteId).OnDelete(DeleteBehavior.Restrict);e.HasOne<InvoiceLine>().WithMany().HasForeignKey(x=>x.InvoiceLineId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<RecurringInvoiceSchedule>(e=>{e.Property(x=>x.Name).HasMaxLength(200);e.Property(x=>x.LinesJson).HasMaxLength(16000);e.Property(x=>x.LastError).HasMaxLength(1000);e.HasIndex(x=>new{x.CompanyId,x.Status,x.NextRunAt});e.HasOne<Customer>().WithMany().HasForeignKey(x=>x.CustomerId).OnDelete(DeleteBehavior.Restrict);e.HasOne<CorporateAccount>().WithMany().HasForeignKey(x=>x.CorporateAccountId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<AccountingJournalLink>(e=>{e.Property(x=>x.EventType).HasMaxLength(100);e.Property(x=>x.IdempotencyKey).HasMaxLength(200);e.Property(x=>x.CorrelationId).HasMaxLength(100);e.HasIndex(x=>new{x.CompanyId,x.EventType,x.IdempotencyKey}).IsUnique();e.HasIndex(x=>new{x.CompanyId,x.CorrelationId});e.HasOne<Journal>().WithMany().HasForeignKey(x=>x.JournalId).OnDelete(DeleteBehavior.Restrict);e.HasOne<Journal>().WithMany().HasForeignKey(x=>x.ReversalJournalId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<SupplierPayment>(e=>{e.Property(x=>x.Reference).HasMaxLength(100);e.Property(x=>x.Amount).HasPrecision(18,2);e.Property(x=>x.UnallocatedAmount).HasPrecision(18,2);e.HasIndex(x=>new{x.CompanyId,x.Reference}).IsUnique();e.HasIndex(x=>new{x.CompanyId,x.SupplierId,x.PaymentDate});e.HasOne(x=>x.Supplier).WithMany().HasForeignKey(x=>x.SupplierId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<SupplierPaymentAllocation>(e=>{e.Property(x=>x.Amount).HasPrecision(18,2);e.HasIndex(x=>new{x.CompanyId,x.SupplierPaymentId,x.SupplierInvoiceId}).IsUnique();e.HasOne(x=>x.SupplierPayment).WithMany(x=>x.Allocations).HasForeignKey(x=>x.SupplierPaymentId).OnDelete(DeleteBehavior.Restrict);e.HasOne(x=>x.SupplierInvoice).WithMany().HasForeignKey(x=>x.SupplierInvoiceId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<BankImportBatch>(e=>{e.Property(x=>x.FileName).HasMaxLength(260);e.Property(x=>x.Sha256).HasMaxLength(64);e.HasIndex(x=>new{x.CompanyId,x.BankAccountId,x.Sha256}).IsUnique();e.HasOne<BankAccount>().WithMany().HasForeignKey(x=>x.BankAccountId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<BankRule>(e=>{e.Property(x=>x.Name).HasMaxLength(200);e.Property(x=>x.DescriptionContains).HasMaxLength(500);e.Property(x=>x.MinimumAmount).HasPrecision(18,2);e.Property(x=>x.MaximumAmount).HasPrecision(18,2);e.Property(x=>x.Department).HasMaxLength(100);e.Property(x=>x.CostCentre).HasMaxLength(100);e.HasIndex(x=>new{x.CompanyId,x.IsActive,x.Priority});e.HasOne<LedgerAccount>().WithMany().HasForeignKey(x=>x.LedgerAccountId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<BankReconciliation>(e=>{e.Property(x=>x.StatementBalance).HasPrecision(18,2);e.Property(x=>x.ReconciledBalance).HasPrecision(18,2);e.Property(x=>x.Status).HasMaxLength(30);e.HasIndex(x=>new{x.CompanyId,x.BankAccountId,x.StatementDate}).IsUnique();e.HasOne<BankAccount>().WithMany().HasForeignKey(x=>x.BankAccountId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<VatAdjustment>(e=>{e.Property(x=>x.Amount).HasPrecision(18,2);e.Property(x=>x.Reason).HasMaxLength(1000);e.HasIndex(x=>new{x.CompanyId,x.AdjustmentDate});e.HasOne<VatReturn>().WithMany().HasForeignKey(x=>x.VatReturnId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<BankTransactionMatch>(e=>{e.Property(x=>x.Amount).HasPrecision(18,2);e.Property(x=>x.Notes).HasMaxLength(1000);e.Property(x=>x.CorrelationId).HasMaxLength(100);e.HasIndex(x=>new{x.CompanyId,x.BankTransactionId,x.Status});e.HasIndex(x=>new{x.CompanyId,x.CorrelationId});e.HasOne(x=>x.BankTransaction).WithMany().HasForeignKey(x=>x.BankTransactionId).OnDelete(DeleteBehavior.Restrict);e.HasOne<Payment>().WithMany().HasForeignKey(x=>x.PaymentId).OnDelete(DeleteBehavior.Restrict);e.HasOne<SupplierInvoice>().WithMany().HasForeignKey(x=>x.SupplierInvoiceId).OnDelete(DeleteBehavior.Restrict);e.HasOne<LedgerAccount>().WithMany().HasForeignKey(x=>x.LedgerAccountId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<VatSubmission>(e=>{e.Property(x=>x.ProviderKey).HasMaxLength(100);e.Property(x=>x.CorrelationId).HasMaxLength(100);e.Property(x=>x.ProviderReference).HasMaxLength(250);e.Property(x=>x.Error).HasMaxLength(2000);e.HasIndex(x=>new{x.CompanyId,x.VatReturnId,x.CreatedAt});e.HasIndex(x=>new{x.CompanyId,x.CorrelationId}).IsUnique();e.HasOne(x=>x.VatReturn).WithMany().HasForeignKey(x=>x.VatReturnId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<AccountingPostingProfile>(e=>{e.Property(x=>x.EventType).HasMaxLength(100);e.HasIndex(x=>new{x.CompanyId,x.EventType}).IsUnique();e.HasOne<LedgerAccount>().WithMany().HasForeignKey(x=>x.DebitAccountId).OnDelete(DeleteBehavior.Restrict);e.HasOne<LedgerAccount>().WithMany().HasForeignKey(x=>x.CreditAccountId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<FinanceRecordState>(e=>{e.Property(x=>x.ResourceType).HasMaxLength(100);e.HasIndex(x=>new{x.CompanyId,x.ResourceType,x.ResourceId}).IsUnique();e.HasIndex(x=>new{x.CompanyId,x.ResourceType,x.IsArchived,x.IsDeleted});});
        modelBuilder.Entity<FinanceRecordHistory>(e=>{e.Property(x=>x.ResourceType).HasMaxLength(100);e.Property(x=>x.Action).HasMaxLength(50);e.Property(x=>x.CorrelationId).HasMaxLength(100);e.HasIndex(x=>new{x.CompanyId,x.ResourceType,x.ResourceId,x.CreatedAt});});
        modelBuilder.Entity<SocialProviderConnection>(e=>{e.Property(x=>x.AccountKey).HasMaxLength(250);e.Property(x=>x.DisplayName).HasMaxLength(250);e.Property(x=>x.Scopes).HasMaxLength(2000);e.Property(x=>x.LastError).HasMaxLength(2000);e.HasIndex(x=>new{x.CompanyId,x.Provider,x.AccountKey}).IsUnique();e.HasIndex(x=>new{x.CompanyId,x.Status,x.TokenExpiresAt});});
        modelBuilder.Entity<OAuthAuthorizationState>(e=>{e.Property(x=>x.StateHash).HasMaxLength(128);e.Property(x=>x.RedirectUri).HasMaxLength(2000);e.HasIndex(x=>new{x.CompanyId,x.StateHash}).IsUnique();e.HasIndex(x=>new{x.CompanyId,x.ExpiresAt,x.ConsumedAt});});
        modelBuilder.Entity<CampaignDelivery>(e=>{e.Property(x=>x.Recipient).HasMaxLength(320);e.Property(x=>x.RecipientType).HasMaxLength(50);e.Property(x=>x.ProviderReference).HasMaxLength(250);e.Property(x=>x.LastError).HasMaxLength(2000);e.HasIndex(x=>new{x.CompanyId,x.Status,x.NextAttemptAt});e.HasIndex(x=>new{x.CompanyId,x.MarketingCampaignId,x.Recipient}).IsUnique();e.HasOne(x=>x.MarketingCampaign).WithMany(x=>x.Deliveries).HasForeignKey(x=>x.MarketingCampaignId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<AnalyticsSession>(e=>{e.Property(x=>x.AnonymousIdHash).HasMaxLength(128);e.Property(x=>x.SessionKeyHash).HasMaxLength(128);e.Property(x=>x.Source).HasMaxLength(100);e.Property(x=>x.Medium).HasMaxLength(100);e.Property(x=>x.Campaign).HasMaxLength(200);e.Property(x=>x.ReferrerHost).HasMaxLength(250);e.HasIndex(x=>new{x.CompanyId,x.SessionKeyHash}).IsUnique();e.HasIndex(x=>new{x.CompanyId,x.StartedAt});});
        modelBuilder.Entity<AnalyticsEvent>(e=>{e.Property(x=>x.Path).HasMaxLength(2000);e.Property(x=>x.Goal).HasMaxLength(100);e.Property(x=>x.Value).HasPrecision(18,2);e.HasIndex(x=>new{x.CompanyId,x.Type,x.OccurredAt});e.HasOne(x=>x.AnalyticsSession).WithMany(x=>x.Events).HasForeignKey(x=>x.AnalyticsSessionId).OnDelete(DeleteBehavior.Restrict);});
        modelBuilder.Entity<AiMarketingGeneration>(e=>{e.Property(x=>x.GenerationType).HasMaxLength(100);e.Property(x=>x.ProviderKey).HasMaxLength(100);e.Property(x=>x.Model).HasMaxLength(100);e.Property(x=>x.Status).HasMaxLength(30);e.HasIndex(x=>new{x.CompanyId,x.GenerationType,x.CreatedAt});});
        modelBuilder.Entity<ContentTaxonomy>(e=>{e.Property(x=>x.Type).HasMaxLength(50);e.Property(x=>x.Slug).HasMaxLength(150);e.Property(x=>x.Name).HasMaxLength(150);e.HasIndex(x=>new{x.CompanyId,x.Type,x.Slug}).IsUnique();});
